...
<tr>
<td align="center"><s:property value="#d.d_name"/></td>
<td align="center"><a href="${pageContext.request.contextPath}/department_edit.action?d_id=<s:property value="#d.d_id"/>"><img src="${pageContext.request.contextPath}/images/bj1.png" alt="编辑"></a></td>
<td align="center"><a href="${pageContext.request.contextPath}/department_delete.action?d_id=<s:property value="#d.d_id"/>"><img src="${pageContext.request.contextPath}/images/t.png" alt="删除"></a></td>
</tr>	
</s:iterator>
</tbody>
</table>
