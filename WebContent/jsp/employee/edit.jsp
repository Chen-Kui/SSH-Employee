...
<s:form action="employee_update" method="post" namespace="/" id="saveForm" >
<s:hidden name="e_id" value="%{model.e_id}"/>
<table border='0' cellpadding="0"  cellspacing="10">
<tr>
<td>姓名：</td>
<td><s:textfield name="e_name" value="%{model.e_name}"/></td>
<td>性别：</td>
...
<tr>
<td>所属部门：</td>
<td><select><s:select name="department.d_id" value="model.department.d_id" list="list" listKey="d_id" listValue="d_name" headerKey="" headerValue="--请选择--"/></select></td>
<td>编号：</td>
<td><s:textfield name="e_no" value="%{model.e_no}"/></td>
</tr>
</table>
</s:form>
